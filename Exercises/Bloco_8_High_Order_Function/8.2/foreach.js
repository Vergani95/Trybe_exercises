...
jogadores.forEach((value, indice, array)=> {
  console.log(`Valor= ${value}, indice= ${indice}, Array= ${array}`)
...
const pessoasEstudantes = [
  ...
  pessoasEstudantes.forEach((estudante)=>{
    ...
    if (mediaFinal >= 7){
      console.log(`O estudante ${estudante.nome} passou com media final ${mediaFinal.toFixed(2)} e esta aprovado!`);
    }
  })